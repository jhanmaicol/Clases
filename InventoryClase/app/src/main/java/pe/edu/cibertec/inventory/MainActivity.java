...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_MAIN && resultCode == RESULT_OK) {
            String nombre = data.getStringExtra("product_nombre");
            String descripcion = data.getStringExtra("product_descripcion");
            int cantidad = data.getIntExtra("product_cantidad",0);
