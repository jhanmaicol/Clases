...
public class ContactActivity extends AppCompatActivity {
    ...
    private class UpdateContacTask extends AsyncTask<Contact,Void,Void> {
        @Override
    ...
    private class InsertContacTask extends AsyncTask<Contact,Void,Void>{
        @Override
        protected Void doInBackground(Contact... contacts) {
    ...
    private class DeleteTask extends AsyncTask<Contact,Void,Void> {
